...
#   c) node1 mines 32 blocks, so now node 0 has 60001btscoin, node 1 has 4250btscoin, node2 has none.
#   d) node0 sends 601 btscoin to node2, in two transactions (301 btscoin, then 300 btscoin).
