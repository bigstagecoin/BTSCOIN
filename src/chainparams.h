 ...
 * BtsCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& BtsCoinDevKey() const { return vBtsCoinDevKey; }
    // const std::vector<unsigned char>& BtsCoinFundKey() const { return vBtsCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vBtsCoinDevKey;
    // std::vector<unsigned char> vBtsCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
