...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BtsCoin Core btscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  btscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BtsCoin transaction") + "\n" +
                               "  btscoin-tx [options] -create [commands]   " + _("Create hex-encoded BtsCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BtsCoin transaction
