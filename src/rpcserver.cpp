...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BtsCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BtsCoin features */
        {"btscoin", "masternode", &masternode, true, true, false},
        {"btscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"btscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"btscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"btscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"btscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"btscoin", "startmasternode", &startmasternode, true, true, false},
        {"btscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"btscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"btscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"btscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"btscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"btscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"btscoin", "mnsync", &mnsync, true, true, false},
        {"btscoin", "spork", &spork, true, true, false},
        {"btscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"btscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use btscoind, or the -server option to btscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> btscoin-cli " + methodname + " " + args + "\n";
}
