...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000007814dfee77cd01c1c595a2180e3aa0c47122a851a4bace18cce5f87a5ac"))
                              ;
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 30;  // BtsCoin: 0.5 minute after 750K
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Manchester United didn't deserve to lose - Solskjaer";
        ...
        assert(hashGenesisBlock == uint256("000007814dfee77cd01c1c595a2180e3aa0c47122a851a4bace18cce5f87a5ac"));
        assert(genesis.hashMerkleRoot == uint256("5093ee16ff94e22aee9bed2952f5a77f65ada7246365f7f92e486e80eec00040"));

        vSeeds.push_back(CDNSSeedData("13.209.179.212", "13.209.179.212"));
        vSeeds.push_back(CDNSSeedData("52.78.225.69", "52.78.225.69"));
        vSeeds.push_back(CDNSSeedData("52.79.149.30", "52.79.149.30"));
        vSeeds.push_back(CDNSSeedData("13.124.27.117", "13.124.27.117"));
        vSeeds.push_back(CDNSSeedData("45.32.249.225", "45.32.249.225"));
        vSeeds.push_back(CDNSSeedData("45.77.11.35", "45.77.11.35"));
        vSeeds.push_back(CDNSSeedData("198.13.63.135", "198.13.63.135"));
        vSeeds.push_back(CDNSSeedData("149.28.23.62", "149.28.23.62"));
        vSeeds.push_back(CDNSSeedData("45.32.253.234", "45.32.253.234"));
        vSeeds.push_back(CDNSSeedData("45.76.192.110", "45.76.192.110"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // BtsCoin: 1 minute
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("btscoin.net", "seed01.btscoin.net"));     // Primary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet BtsCoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet BtsCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet BtsCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet BtsCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet BtsCoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1552294334; //Fri, 09 Jan 2015 21:05:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
