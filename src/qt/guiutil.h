...
/** Utility functions used by the BtsCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BtsCoin addresses in monospace font
...
// Parse "btscoin:" URI into recipient object, return true on successful parsing
