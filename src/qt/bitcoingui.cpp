...
QFontDatabase::addApplicationFont(":/fonts/btscoin_font");

QString windowTitle = tr("BtsCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BtsCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BtsCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BtsCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BtsCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BtsCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BtsCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BtsCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BtsCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BtsCoin Core help message to get a list with possible BtsCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BtsCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BtsCoin network", "", count));
}
...
{
    QString strTitle = tr("BtsCoin Core"); // default title
