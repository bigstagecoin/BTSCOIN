/* src/config/btscoin-config.h.  Generated from btscoin-config.h.in by configure.  */
/* src/config/btscoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BtsCoin_CONFIG_H

#define BtsCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.btscoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BtsCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BtsCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "btscoin"
