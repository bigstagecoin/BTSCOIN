...
#if defined(NDEBUG)
#error "BtsCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubtscoin) are considered zero fee (for relaying and mining)
