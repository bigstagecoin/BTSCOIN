Contributing to BtsCoin Core
============================

The BtsCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BtsCoin Core project, and is not to be
confused with overall BtsCoin Network Protocol consensus changes.

Whether a pull request is merged into BtsCoin Core rests with the project merge
...
Patches that change BtsCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BtsCoin consensus, it must have been
...
The project leader is the release manager for each BtsCoin Core release.
